...
contract PlayPadSaleSeed is ReentrancyGuard, Ownable {
    ...
    function claimTokens() external nonReentrant {
        ...
        require(investor.claimedValue <= investor.claimedValue.add(investor.totalBuyingAmountToken.mul(roundDetail.roundPercent).div(100)));
